...
export function playCircleAppearSound(step=0){ if(!canPlaySound())return; const notes=["E5","G5","A5","C6"]; appearSynth.triggerAttackRelease(notes[step%notes.length],0.11,getStrictStartTime("lv2-appear",0.03)); }
